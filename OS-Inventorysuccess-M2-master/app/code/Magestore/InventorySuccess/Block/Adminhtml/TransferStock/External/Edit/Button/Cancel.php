 ...
 * Class SaveButton
 */
class Cancel extends \Magestore\InventorySuccess\Block\Adminhtml\TransferStock\AbstractTransferStock
                 implements ButtonProviderInterface
{
    ...
    public function getButtonData()
    {
        if ($this->getRequest()->getParam('id')) {
            ...
            if(($transferStock->getStatus() == TransferStock::STATUS_PENDING) && $this->_permissionManagement->checkPermission(TransferPermission::EXTERNAL_TRANSFER_STOCK_EDIT_GENERAL)){
                return [
                    'label' => __('Cancel'),
                    'class' => 'save primary',
                    'data_attribute' => [
