 ...
 */
class General extends \Magestore\InventorySuccess\Ui\DataProvider\TransferStock\Request\Form\Modifier\RequestStock
{
    ...
    public function getCurrentTransfer()
    {
        ...
        if ($transferStock->getId()) {
            ...
            $transferStock = $this->_coreRegistry->registry("current_request_stock");
        }
    ...
    public function getAttributesMeta()
    {
        ...
        $result['source_warehouse_id']['options'] = $this->_warehouseSource->toOptionArray(TransferPermission::ALL_WAREHOUSE_SEND_REQUEST);
        $result['des_warehouse_id']['componentType'] = Field::NAME;
        $result['des_warehouse_id']['options'] = $this->_warehouseSource->toOptionArray(TransferPermission::REQUEST_STOCK_CREATE);
