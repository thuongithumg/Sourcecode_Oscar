...
define(
    ...
    function (onlineAbstract, addNotification, __, Alert) {
        ...
        return onlineAbstract.extend({
            initialize: function () {
                this._super();
                this.apiStartPaymentUrl = "/webpos/paynl/startPayment";
                this.apiSendInvoiceUrl = "/webpos/paynl/sendInvoice";
                this.finishPaymentUrl = "/webpos/paynl/finishPayment";
            },
            getCallBackEvent: function(key){
                switch(key){
                    case "startPayment":
                        return "paynl_start_payment_after";
                    case "sendInvoice":
                        return "paynl_send_invoice_after";
                }
            },
