...
define(
    ...
    function ($, ko, _, OrderFactory, PaymentFactory, $t, Component, invoice, eventmanager, createInvoiceAction, Alert, Confirm, priceHelper, Helper) {
        ...
        return Component.extend({
            ...
            /**
             * get shipping tax amount for invoice after load order
             *
             * @returns {number}
             */
            getShippingTaxAmount: function () {
                if (this.orderData().base_shipping_invoiced)
                    return 0;
                else if (this.orderData().shipping_tax_amount)
                    return parseFloat(this.orderData().shipping_tax_amount);
                else
                    return 0;
            },
            ...
            getGrandTotal: function () {
                ...
                var grantotal = this.getSubtotal() 
                    + this.getShippingAmount() 
                    + this.getShippingTaxAmount() 
                    + base_tax_amount - base_discount_amount;
            ...
            collectTotals: function (orderData) {
                ...
                this.taxAmount = ko.pureComputed(function () {
                    var base_tax_amount = self.getShippingTaxAmount();
                    if (self.orderData.call()) {
                        $.each(self.orderData.call().items, function (index, value) {
                ...
                this.grandTotal = ko.pureComputed(function () {
                    ...
                    if (self.orderData.call()) {
                        ...
                        grandtotal += self.getShippingTaxAmount();
                    }
