...
define(
    ...
    function ($, onlineAbstract, actionLog, urlBuilder, storage, Cookies, eventManager, Helper, notification) {
        "use strict";
                    ...
                    case 'post':
                        if (self.push) {
                            storage.post(
                                ...
                                function (response) {
                                    if (response != 'pos_locked') {
                                        deferred.resolve(response);
                                        if(callBack) {
                                            eventManager.dispatch(callBack, {'response': response});
                                        }
                                    } else {
                                        $('#webpos_lockscreen').show();
                                        $('#lock-screen-input').removeAttr('disabled');
                    ...
                    if(response.responseText){
                        ...
                        if(error.message != undefined){
                            ...
                            if (typeof error.parameters !== 'undefined') {
                                ...
                                Helper.alert({priority:"danger",title: Helper.__("Error"),message: Helper.__(error.message).replace('%1', parameters[0])});
                            } else {
