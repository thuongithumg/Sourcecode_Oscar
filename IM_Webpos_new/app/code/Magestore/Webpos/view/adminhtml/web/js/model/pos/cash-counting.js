...
define(
    ...
    function (ko, $, HelperPrice, PosManagement, Event) {
        'use strict';
        ...
        var CountingItem = function(item){
            ...
            self.subtotalFormated = ko.pureComputed(function(){
                return HelperPrice.formatPrice(self.subtotal());
            });
            return self;
        };
        ...
        var CashCounting = {
            ...
            initObserver: function(){
                ...
                Event.observer(PosManagement.EVENT_INIT_DATA_AFTER, function(){
                    self.cashValues(PosManagement.denominations());
                });
                return self;
            },
            /**
            ...
            initData: function(cashValues){
                var self = this;
                var cashValues = (cashValues)?cashValues: [];
