...
class Shortfall extends \Magestore\InventorySuccess\Ui\DataProvider\TransferStock\Request\Form\Modifier\RequestStock
{
    ...
    protected $_modifierConfig = [
        ...
        'listing' => 'os_transferstock_shortfall_product_selection',
        'form' => 'transferstock_request_form',
        'columns_ids' => 'os_transferstock_shortfall_product_selection_columns.ids',
        'history_listing' => 'transferstock_shortfall_history'
    ];
...
//                ],
    ...
    public function getAddProductButton($buttons)
    {
    ...
    public function getSaveReturnButton($buttons)
    {
    ...
    public function getSaveReceiveButton($buttons)
    {
