...
class WarehousePermission implements \Magento\Ui\DataProvider\Modifier\ModifierInterface
{
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $permissionStaff = $this->_permissionManagement->checkPermission('Magestore_InventorySuccess::warehouse_permission',                    $this->_warehouseFactory->create()->load($this->_requestInterface->getParam('id')));
            ...
            [
                'warehouse_permission' => [
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label' => __('Warehouse Permissions'),
                                'autoRender' => true,
                                'collapsible' => true,
                                'visible' => true,
                                'opened' => false,
