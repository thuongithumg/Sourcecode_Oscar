...
namespace Magestore\InventorySuccess\Ui\DataProvider\Permission\Staff\Modifier;
...
class ModifierFormDataProvider extends Dynamic
{
     ...
     * @var string
     */
    protected $_buttonTitle = 'Assign Warehouses';
     ...
     * @var string
     */
    protected $_modalButtonTitle = 'Add Selected Warehouses';
    ...
    protected $_modifierConfig = [
        ...
        'listing' => 'os_user_permission_warehouse_listing',
        'columns_ids' => 'os_user_permission_warehouse_listing_columns.ids',
        'form' => 'os_user_permission_form'
    ];
    ...
    {
        return [
            'id' => $this->getTextColumn('id', false, __('ID'), 1),
            'object_id' => [
                'arguments' => [
                    'data' => [
                        'config' => [
            ...
            'object_name' => $this->getTextColumn('object_name', false, __('Warehouse'), 20),
            'role_id' => [
                'arguments' => [
                    'data' => [
                        'config' => [
