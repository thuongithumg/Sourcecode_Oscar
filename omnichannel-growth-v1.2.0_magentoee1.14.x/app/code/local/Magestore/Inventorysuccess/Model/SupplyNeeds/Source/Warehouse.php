 ...
 */
class Magestore_Inventorysuccess_Model_SupplyNeeds_Source_Warehouse extends Magestore_Inventorysuccess_Model_SupplyNeeds_Source_AbstractSource
{
    ...
    public function getAvailableWarehouse()
    {
        ...
        $resourceId = 'admin/inventorysuccess/prediction/supply_needs';
        $warehouseCollection = Magestore_Coresuccess_Model_Service::permissionService()->filterPermission(
            $warehouseCollection,
            $resourceId
        );
