 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Grid constructor.
     */
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('inventorysuccess/transferstock')->getCollection()
            ->addFieldToFilter('type', Magestore_Inventorysuccess_Model_Transferstock::TYPE_REQUEST);
        $resourceId = 'admin/inventorysuccess/view_transferstock/view_requeststock';
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('qty', array(
            'header' => Mage::helper('inventorysuccess')->__('Qty Requested'),
            'align' => 'right',
            'width' => '50px',
            'index' => 'qty',
            'type'  => 'number',
        ...
        $this->addColumn('qty_delivered', array(
            'header' => Mage::helper('inventorysuccess')->__('Qty Delivered'),
            'align' => 'right',
            'width' => '50px',
            'index' => 'qty_delivered',
            'type'  => 'number',
