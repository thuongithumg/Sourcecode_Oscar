 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Sample
    extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Sample constructor.
     */
