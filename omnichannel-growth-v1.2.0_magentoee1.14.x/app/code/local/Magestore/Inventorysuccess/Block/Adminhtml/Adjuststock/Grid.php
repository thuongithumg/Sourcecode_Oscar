 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Adjuststock_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Adjuststock_Grid constructor.
     */
     ...
     *
     * @return Magestore_Inventorysuccess_Block_Adminhtml_Adjuststock_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('inventorysuccess/adjuststock')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('adjuststock_code', array(
            'header'    => Mage::helper('inventorysuccess')->__('Adjustment Code'),
            'align'     =>'left',
            'index'     => 'adjuststock_code',
        ));
        ...
        $this->addColumn('status', array(
            ...
            'index'     => 'status',
            'type'        => 'options',
            'options'     => Mage::getModel('inventorysuccess/adjuststock_options_status')->toOptionHash()
        ));
