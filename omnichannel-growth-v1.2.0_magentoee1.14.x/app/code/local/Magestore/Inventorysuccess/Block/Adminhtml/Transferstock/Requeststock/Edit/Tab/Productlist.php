 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Edit_Tab_Productlist
    extends
    Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('request_productList');
        ...
        $this->setChild('import_button',
                        $this->getLayout()->createBlock('adminhtml/widget_button')
                             ->setData(array(
                                           ...
                                           'onclick' => "jQuery('#import-request').modal()",
                                           'class'   => 'import-csv',
                                       ))
        );

        $handleBarcodeUrl = Mage::helper('adminhtml')->getUrl(
            'adminhtml/inventorysuccess_transferstock_requeststock/handleBarcode',
    ...
    public function getSelectedProducts()
    {
        if ( !$this->_selectedProducts ) {
            ...
            } elseif ( Mage::getSingleton('adminhtml/session')->getData('request_products') ) {
                $data = Mage::getSingleton('adminhtml/session')->getData('request_products');
            }
