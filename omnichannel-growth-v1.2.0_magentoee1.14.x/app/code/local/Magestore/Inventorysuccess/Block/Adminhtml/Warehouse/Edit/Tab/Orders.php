 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Warehouse_Edit_Tab_Orders extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('sales/order_grid_collection')
            ...
            ->addFieldToFilter('warehouse_id', Mage::registry('current_warehouse')->getId())
