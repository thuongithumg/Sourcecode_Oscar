 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Sendstock_Edit_Tab_Stocksummary
    extends
    Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Sendstock_Edit_Tab_Stocksummary constructor.
     */
        ...
        $this->setChild('download_summary',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick' => "location.href ='" . $this->getUrl('*/*/exportSummary', array('_current' => true)) . "'",
                    'class' => 'task',
                ))
        );
