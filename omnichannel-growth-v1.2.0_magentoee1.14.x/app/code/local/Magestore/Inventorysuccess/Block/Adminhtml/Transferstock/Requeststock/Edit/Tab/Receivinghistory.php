...
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Edit_Tab_Receivinghistory
    extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Edit_Tab_Receivinghistory constructor.
     */
    public function __construct()
    {
        parent::__construct();
        $this->setId('receivinghistory');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('total_qty', array(
            'header' => Mage::helper('inventorysuccess')->__('Received Qty'),
            'filter' => false,
            'type' => 'number',
            'width' => '20px',
            'name' => 'total_qty',
    ...
    {
        return $this->getUrl('*/*/receivinghistorygrid', array(
            '_current' => true
        ));
    }
}
