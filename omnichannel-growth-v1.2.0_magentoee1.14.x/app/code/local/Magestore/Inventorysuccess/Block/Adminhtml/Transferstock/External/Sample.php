 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_External_Sample
    extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_External_Sample constructor.
     */
    ...
    protected function _prepareCollection()
    {
        ...
        if ($transferStockModel->getId()) {
            ...
            if (!$wareHouseId) {
                $wareHouseId = $transferStockModel->getData('des_warehouse_id');
            }
