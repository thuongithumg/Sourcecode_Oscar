 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Sendstock_Edit_Tab_Productlist
    extends
    Mage_Adminhtml_Block_Widget_Grid
{
    ...
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Sendstock_Edit_Tab_Productlist constructor.
     */
    public function __construct()
    {
        parent::__construct();
        $this->setId('send_productList');
        ...
        $this->setChild('import_button',
                        $this->getLayout()->createBlock('adminhtml/widget_button')
                             ->setData(array(
                                           ...
                                           'onclick' => "jQuery('#import-send').modal();",
                                           'class'   => 'import-csv',
                                       ))
        );
        $handleBarcodeUrl = Mage::helper('adminhtml')->getUrl(
            'adminhtml/inventorysuccess_transferstock_sendstock/handleBarcode',
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('qty', array(
            'header'     => Mage::helper('catalog')->__('Qty to send'),
            'index'      => 'qty',
            'type'       => 'input',
            'name'       => 'qty',
            'filter'     => false,
    ...
    public function getSelectedProducts()
    {
        if ( !$this->_selectedProducts ) {
            ...
            } elseif ( Mage::getSingleton('adminhtml/session')->getData('send_products') ) {
                $data = Mage::getSingleton('adminhtml/session')->getData('send_products');
            }
