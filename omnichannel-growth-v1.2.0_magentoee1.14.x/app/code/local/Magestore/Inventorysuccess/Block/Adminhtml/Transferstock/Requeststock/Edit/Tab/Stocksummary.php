 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Edit_Tab_Stocksummary
    extends
    Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Inventorysuccess_Block_Adminhtml_Transferstock_Requeststock_Edit_Tab_Stocksummary constructor.
     */
    ...
    protected function _prepareCollection()
    {
        ...
        if ( $this->getData('is_shortfall') ) {
            $collection->getSelect()->where('qty != qty_received');
        }
