 ...
 */
class Magestore_Inventorysuccess_Block_Adminhtml_Catalog_Product_Edit_Tab_Renderer_Supplier
    extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _toHtml()
    {
        ...
        $selectOptions = '';
        $supplierOptions = Magestore_Coresuccess_Model_Service::supplierService()->getSupplierOptionHash();
        if(count($supplierOptions)) {
