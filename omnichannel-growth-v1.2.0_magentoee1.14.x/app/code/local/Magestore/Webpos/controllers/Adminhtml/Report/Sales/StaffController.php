 ...
 */
class Magestore_Webpos_Adminhtml_Report_Sales_StaffController extends Mage_Adminhtml_Controller_Report_Abstract {
...
//        $this->_showLastExecutionTime(Mage_Reports_Model_Flag::REPORT_ORDER_FLAG_CODE, 'sales');
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_report_sales_staff.grid');
    ...
    {
        $fileName   = 'sales.csv';
        $grid       = $this->getLayout()->createBlock('webpos/adminhtml_report_sales_staff_grid');
