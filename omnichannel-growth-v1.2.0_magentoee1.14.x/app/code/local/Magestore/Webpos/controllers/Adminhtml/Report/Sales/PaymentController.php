 ...
 */
class Magestore_Webpos_Adminhtml_Report_Sales_PaymentController extends Mage_Adminhtml_Controller_Report_Abstract {
...
//        $this->_showLastExecutionTime(Mage_Reports_Model_Flag::REPORT_ORDER_FLAG_CODE, 'sales');
        $this->_initAction()
            ...
            ->_addBreadcrumb(Mage::helper('adminhtml')->__('Sales by payment method'), Mage::helper('adminhtml')->__('Sales by payment method'));

        $gridBlock = $this->getLayout()->getBlock('adminhtml_report_sales_payment.grid');
    ...
    {
        $fileName   = 'sales.csv';
        $grid       = $this->getLayout()->createBlock('webpos/adminhtml_report_sales_payment_grid');
