 ...
 */
class Magestore_Webpos_Adminhtml_Report_Sales_Staff_Order_ListController extends Mage_Adminhtml_Controller_Report_Abstract {
...
//        $this->_showLastExecutionTime(Mage_Reports_Model_Flag::REPORT_ORDER_FLAG_CODE, 'sales');
        ...
        $this->_initAction()
            ...
            ->_addBreadcrumb(Mage::helper('adminhtml')->__('Sales Report'), Mage::helper('adminhtml')->__('Sales Staff Order List Report'));

        $gridBlock = $this->getLayout()->getBlock('adminhtml_report_sales_staff_order_list.grid');
    ...
    public function bestsellersAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_report_salestaff.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    {
        $fileName   = 'sales.csv';
        $grid       = $this->getLayout()->createBlock('webpos/adminhtml_report_sales_staff_order_list_grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
