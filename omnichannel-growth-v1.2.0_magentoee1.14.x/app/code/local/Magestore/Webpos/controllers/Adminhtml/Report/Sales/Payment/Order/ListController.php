 ...
 */
class Magestore_Webpos_Adminhtml_Report_Sales_Payment_Order_ListController extends Mage_Adminhtml_Controller_Report_Abstract {
    ...
    public function indexAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_report_sales_payment_order_list.grid');
    ...
    {
        $fileName   = 'sales.csv';
        $grid       = $this->getLayout()->createBlock('webpos/adminhtml_report_sales_payment_order_list_grid');
