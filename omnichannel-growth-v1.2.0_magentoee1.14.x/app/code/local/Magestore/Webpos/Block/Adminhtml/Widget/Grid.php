 ...
 */
class Magestore_Webpos_Block_Adminhtml_Widget_Grid extends Mage_Adminhtml_Block_Widget
{
    /**
     * Columns array
     *
    ...
    public function __construct($attributes=array())
    {
        ...
        $this->setTemplate('webpos/grid.phtml');
        ...
        foreach ($this->_columns as $column) {
            ...
            if (!$column->getIsSystem()) {
                if ($i == 1) {
                    ...
                    if ($column->getData('type') == 'number' || $column->getData('type') == 'currency') {
