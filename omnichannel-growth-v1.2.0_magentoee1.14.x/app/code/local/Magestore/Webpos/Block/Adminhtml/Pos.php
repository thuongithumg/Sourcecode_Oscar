 ...
 * Time: 10:20 SA
 */
class Magestore_Webpos_Block_Adminhtml_Pos extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_pos';
        $this->_blockGroup = 'webpos';
        $this->_headerText = Mage::helper('webpos')->__('Manage POS');
        $this->_addButtonLabel = Mage::helper('webpos')->__('Add POS');
        parent::__construct();
        $buttonList = array();
