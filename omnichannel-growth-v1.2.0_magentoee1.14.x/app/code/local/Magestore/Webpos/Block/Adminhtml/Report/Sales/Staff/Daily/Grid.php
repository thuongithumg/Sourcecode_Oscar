 ...
 */
class Magestore_Webpos_Block_Adminhtml_Report_Sales_Staff_Daily_Grid extends Magestore_Webpos_Block_Adminhtml_Report_Grid_Abstract
{
    ...
    {
        return 'webpos/sales_staff_daily_collection';
    }
