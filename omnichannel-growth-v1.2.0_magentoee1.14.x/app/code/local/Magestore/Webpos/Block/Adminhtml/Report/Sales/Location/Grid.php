 ...
 */
class Magestore_Webpos_Block_Adminhtml_Report_Sales_Location_Grid extends Magestore_Webpos_Block_Adminhtml_Report_Grid_Abstract
{
    ...
    {
        return 'webpos/sales_location_collection';
    }
