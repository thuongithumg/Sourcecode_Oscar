 ...
 */
class Magestore_Webpos_Block_Adminhtml_Report_Sales_Payment_Location_Grid extends Magestore_Webpos_Block_Adminhtml_Report_Grid_Abstract
{
    ...
    {
        return 'webpos/sales_payment_location_collection';
    }
