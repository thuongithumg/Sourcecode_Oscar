...
/**
 * Class Magestore_Reportsuccess_Block_Adminhtml_Inventoryreport_Details_Details
 */
class Magestore_Reportsuccess_Block_Adminhtml_Inventoryreport_Details_Details
    extends Mage_Core_Block_Template
{
     ...
     * @var string
     */
    protected $type=Magestore_Reportsuccess_Helper_Data::DETAILS;
    /**
     * @var bool
     */
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                'reportsuccess/adminhtml_inventoryreport_details_grid',
                'report_detailsgrids.grid'
            );
        }
    ...
    public function getUrlTotalsReport(){
        return  Mage::helper('adminhtml')->getUrl('adminhtml/inventoryreport_details/getTotals');
    }
