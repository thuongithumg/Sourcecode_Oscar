 ...
 */
class Magestore_Barcodesuccess_Block_Adminhtml_Barcode_Edit_Tab_Print extends
    Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('barcode_view_print', array(
...
//            'text'  => "
//                        <span class='form-button' onclick='barcodeForm.loadPreview();'>Preview</span>
//                        ",
//        ));
        ...
        $fieldset->addField('print_button', 'note', array(
            'label' => Mage::helper('barcodesuccess')->__(' '),
            'text'  => "
                        <span class='form-button' onclick='barcodeForm.print();'>Print</span>
                        ",
        ));
