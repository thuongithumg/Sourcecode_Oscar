 ...
 */
class Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Returneditem_Returnitem_Grid
    extends Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Purchasesummary_Abstractmodalgrid
{
     ...
     * @var string
     */
    protected $gridId = 'purchase_order_returned_item_return_item_list';

    /**
     * @var string
     */
    protected $hiddenInputField = 'selected_return_item';

    /**
     * @var array
     */
    protected $editFields = array('return_qty');
    ...
    protected function modifyColumn()
    {
        ...
        $this->removeColumn('qty_orderred');
    ...
    {
        return $this->getUrl(
            "*/purchaseordersuccess_purchaseorder_returneditem/gridmodal",
    ...
    {
        return $this->getUrl(
            '*/purchaseordersuccess_purchaseorder_returneditem/return',
            array("_current" => true, 'supplier_id' => $this->purchaseOrder->getSupplierId())
        );
    }
}