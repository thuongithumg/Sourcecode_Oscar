...
class Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Transferreditem_Importtransferreditem
    extends Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Abstracttab
{
    ...
    {
        parent::_construct();
        $this->setTemplate('purchaseordersuccess/purchaseorder/edit/tab/transferred_item/import_transfer_item.phtml');
    ...
    public function getCsvSampleLink(){
        return $this->getUrl(
            "*/purchaseordersuccess_purchaseorder_transferreditem_import/downloadSample",
    ...
    public function getImportLink(){
        return $this->getUrl(
            "*/purchaseordersuccess_purchaseorder_transferreditem_import/import",
