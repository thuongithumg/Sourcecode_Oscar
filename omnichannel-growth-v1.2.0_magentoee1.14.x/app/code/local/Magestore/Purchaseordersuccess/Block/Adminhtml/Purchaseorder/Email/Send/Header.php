 ...
 */
class Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Email_Send_Header
    extends Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Purchasesummary_Header
{
    protected $_template = 'purchaseordersuccess/purchaseorder/email/email_send_header.phtml';
    ...
    protected function getCsvUrl() {
        return Mage::getUrl('purchaseordersuccess/purchaseorder/downloadcsv', ['key' => $this->getPurchaseOrderData('purchase_key')]);
    }

    protected function getPdfUrl() {
        return Mage::getUrl('purchaseordersuccess/purchaseorder/downloadpdf', ['key' => $this->getPurchaseOrderData('purchase_key')]);
    }
