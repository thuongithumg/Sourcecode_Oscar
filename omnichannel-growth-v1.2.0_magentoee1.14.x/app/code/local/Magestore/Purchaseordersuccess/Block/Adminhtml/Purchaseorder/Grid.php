 ...
 */
class Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Grid 
    extends Magestore_Purchaseordersuccess_Block_Adminhtml_Abstractgrid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('purchaseorder_list');
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('purchase_code',
            array(
                'header'    => $this->__('Purchase Order Number'),
                'align'     => 'right',
                'width'     => '200',
                'index'     => 'purchase_code',
            ...
            array(
                ...
                'type'      => 'number',
        ))->addColumn('total_qty_received',
            array(
                'header'    => $this->__('Received Qty'),
                'align'     =>'left',
                'index'     => 'total_qty_received',
                'type'      => 'number',
