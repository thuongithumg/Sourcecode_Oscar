...
class Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Returneditem_Returnitem
    extends Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_Abstracttab
{
    /**
     * @var string
     */
    protected $_template = 'purchaseordersuccess/purchaseorder/edit/tab/returned_item/return_item.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                'purchaseordersuccess/adminhtml_purchaseorder_edit_tab_returneditem_returnitem_grid',
                'purchaseorder.returneditem.returnitem.grid'
            );
        }
    ...
    public function addReturnedTimeField(){
        $html = $this->addField('returned_at',
            'date',
            array(
                'name'      => 'returned_at',
                'time'      => false,
