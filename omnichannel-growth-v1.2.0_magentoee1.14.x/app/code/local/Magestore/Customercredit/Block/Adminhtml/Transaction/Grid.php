...
class Magestore_Customercredit_Block_Adminhtml_Transaction_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    /**
     * Magestore_Customercredit_Block_Adminhtml_Transaction_Grid constructor.
     */
...
//                'main_table.customer_id = customer_entity_varchar.entity_id', array('customer_name' => 'value')
//            )
//            ->group('main_table.customer_id')
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('customer_name', array(
            ...
            'index' => 'customer_name',
            'filter_index' => new Zend_Db_Expr("CONCAT(`table_cev1`.`value`, ' ',`table_cev2`.`value`)"),
        ));
