...
/**
 * Class Magestore_Storepickup_Model_Order_Pdf_Abstract
 */
class Magestore_Storepickup_Model_Order_Pdf_Abstract extends Mage_Sales_Model_Order_Pdf_Invoice
{
        ...
        if (!$order->getIsVirtual()) {
            ...
            foreach($shiipingInfo as $value){
                if(strpos($value, '<img')===false){
                    ...
                    $url = preg_match('/http.(.*).[\w]+/i', $value, $res);
                    $url = rtrim($res[0]);
                    $fix_i++;
                }
            }
            ...
            try{
                ...
                if (is_file($baseImage)) {
                    ...
                    $page->drawImage($image, 285, $this->y - 100, 400, $this->y - 100 + (400-285));
                }
            }catch(Exception $e){
