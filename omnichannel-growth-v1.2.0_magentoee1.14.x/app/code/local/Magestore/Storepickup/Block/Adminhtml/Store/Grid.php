...
/**
 * Class Magestore_Storepickup_Block_Adminhtml_Store_Grid
 */
class Magestore_Storepickup_Block_Adminhtml_Store_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Magestore_Storepickup_Block_Adminhtml_Store_Grid constructor.
     */
    ...
    protected function _prepareColumns()
    {
        ...
        if (Mage::helper('core')->isModuleEnabled('Magestore_Inventorysuccess')){
            $this->addColumn('warehouse', array(
                'header' => Mage::helper('storepickup')->__('Warehouse'),
                'align' => 'left',
                'width' => '50px',
                'index' => 'warehouse_id',
                'type' => 'options',
                'options' => Mage::getModel('inventorysuccess/warehouse')->getCollection()->getOptionArray(),
            ));
        }
