 ...
 */
class Magestore_Suppliersuccess_Block_Adminhtml_Supplier extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_supplier';
        $this->_blockGroup = 'suppliersuccess';
        $this->_headerText = Mage::helper('suppliersuccess')->__('Supplier Management');
