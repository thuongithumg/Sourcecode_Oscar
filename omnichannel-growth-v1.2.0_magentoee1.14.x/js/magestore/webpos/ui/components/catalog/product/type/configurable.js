...
define(
    ...
    function ($, ko, _, mageTemplate, priceHelper, priceBox) {
        return {
            ...
            _initializeOptions: function () {
                //$(this.options.priceHolderSelector).priceBox({'priceConfig': this.priceConfig});
            ...
            _configureElement: function (element) {
                ...
                if (element.value) {
                    ...
                    self.detailPopup().basePriceAmount(this.options.spConfig.optionPrices[this.simpleProduct].basePrice.amount);
                    self.detailPopup().defaultPriceAmount(priceHelper.convertAndFormat(this.options.spConfig.optionPrices[this.simpleProduct].basePrice.amount));
                    ...
                    $.map(labelObject, function (val, index) {
                        ...
                        if(attributes[index]){
                            attributesInfo.push({label:attributes[index].label, value:val});
                        }
                    });
                    self.detailPopup().configurableOptionsAttributesInfoResult(attributesInfo);
            ...
            _resetConfigurable: function () {
                this.options.state = [];
                this.options.lableConfig = [];
