...
define(
    [
        ...
        'model/adminhtml/pos/cash-adjustment',
        'helper/price',
        'helper/datetime',
        'eventManager',
        'ui/lib/modal/modal',
    ...
    function ($, ko, Component, PosManagement, CashAdjustment, PriceHelper, DatetimeHelper, Event, Modal, __) {
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'ui/adminhtml/pos/cash-adjustment',
            },
            ...
            initialize: function () {
                ...
                Event.observer('start_put_money_in', function(){
                    ...
                    self.adjustmentTitle(__('Put Money In'));
                    self.adjustmentNotice(__('Fill in this form if you put money in the cash-drawer'));
                    self.openForm();
                });
                Event.observer('start_take_money_out', function(){
                    CashAdjustment.type('remove');
                    self.adjustmentTitle(__('Take Money Out'));
                    self.adjustmentNotice(__('Fill in this form if you take money from the cash-drawer'));
                    self.openForm();
                });
            },
