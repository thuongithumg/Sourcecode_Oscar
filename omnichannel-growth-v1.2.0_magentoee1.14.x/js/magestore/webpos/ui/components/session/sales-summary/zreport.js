...
define(
    ...
    function ($, ko, Component,  priceHelper, datetimeHelper, ShiftData) {
        "use strict";
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'ui/session/sales-summary/zreport',
            },
            ...
            setShiftData: function(data){
                ...
                this.cashRefundFormatted(priceHelper.formatPrice(-data.refund_amount));
