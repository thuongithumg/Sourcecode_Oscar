...
define(
    ...
    function ($, ko, Component, cashTransactionModel, shift, priceHelper, datetimeHelper, notification, Event, shiftOnlineResource, CashCounting, ShiftData, PosManagement, confirm, Translate) {
        "use strict";
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'ui/session/session/close-session',
            },
            ...
            getShiftDataOnline: function () {
                ...
                //postData.closed_at = datetimeHelper.getBaseSqlDatetime(dateGmt0);
            ...
            getLastTransactionData: function () {
                ...
                var data = {
                    ...
                    'note': Translate('Remove cash when closed Session'),
                    'balance': balance,
            ...
            setClosingBalance: function(){
                ...
                if (ShiftData.differenceAmount() !== 0) {
                    if (ShiftData.differenceAmount() > 0) {
                        compareText = Translate('Profit: ');
                    } else {
                        compareText = Translate('Loss: ');
                    }
                    confirm({
