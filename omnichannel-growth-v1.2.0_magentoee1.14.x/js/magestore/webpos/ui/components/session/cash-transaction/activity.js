...
define(
    ...
    function ($, ko, listAbstract, datetimeHelper, priceHelper, Event, $t) {
        "use strict";
        ...
        return listAbstract.extend({
            ...
            defaults: {
                template: 'ui/session/cash-transaction/activity',
            },
            ...
            processItemsVisibility: function(data){
                ...
                $.each(items, function(index, item){
                    var type = (item.type == 'remove'||item.type == 'refund')?'remove':'add';
